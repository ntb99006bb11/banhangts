...
<div class="dashboard-widget big-counter">
    <ul class="list-inline">
         <li>
            <div class="title"><?php esc_html_e( 'Sales', 'steelthemes-nest' ); ?></div>
            <div class="count"><?php echo wp_kses_post( wc_price( $earning ) ); ?></div>
        </li>
        <li>
            <div class="title"><?php esc_html_e( 'Earning', 'steelthemes-nest' ); ?></div>
            <div class="count"><?php echo wp_kses_post( dokan_get_seller_earnings( dokan_get_current_user_id() ) ); ?></div>
        </li>
        <li>
            <div class="title"><?php esc_html_e( 'Pageview', 'steelthemes-nest' ); ?></div>
            <div class="count"><?php echo esc_html( dokan_number_format( esc_attr( $pageviews ) ) ); ?></div>
        </li>
        <li>
            <div class="title"><?php esc_html_e( 'Order', 'steelthemes-nest' ); ?></div>
            <div class="count">
                <?php
